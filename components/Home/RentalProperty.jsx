...
export default function RentalProperty() {
  ...
  // Update currentIndex if viewport resizing makes the maxIndex smaller than currentIndex
                ...
                >
                  ...
                  <div className="bg-white rounded-[20px] transition-all duration-300 flex flex-col h-full border border-gray-100 p-2.5">
                    ...
                    >
                      ...
                      {/* Price Badge - Dark transparent badge matching design guidelines */}
                      <span className="absolute left-[15px] top-[15px] px-[14px] py-[10px] bg-[#1D1D1D]/90 backdrop-blur-[10px] rounded-[10px] text-white font-semibold text-[20px] font-sans border border-white/10 z-10 flex items-baseline gap-1">
                        <span>{property.price}</span>
                        {property.period && (
                          <small className="text-xs font-normal font-sans text-gray-300">
                            {property.period}
                          </small>
                        )}
                      </span>
